...
<html>
	...
	<body>
		<center><h3>Naudotojo <?php echo $vardas; ?> sąskaitos</h3></center>
<table style="margin: 0px auto;" id="zinutes">

		
<?php	
//  nuskaityti 
	$userID = getUserID($vardas);
	$sql =  "SELECT * FROM $lentele WHERE vartotojoID_fk = '$userID'";
	...
	while($row = $result->fetch_assoc()) 
	{
		...
		echo "<tr>
		<td>[<a href=\"mokejimaiList.php?id={$row['serijosNr']}\">Sąskaitos mokėjimai</a>] &nbsp;&nbsp;
		</tr>";
	}
	//echo "</table>";
